// Code generated by scripts/generate-data.ts from data/calendar.json. DO NOT EDIT.
//
// Source: github.com/suprimkhatri77/go-bs@v0.6.1 (see docs/calendar-data.md).
...
export const DATA_MIN_YEAR = 1979;

/** The last BS year in CALENDAR_DATA. */
export const DATA_MAX_YEAR = 2100;
